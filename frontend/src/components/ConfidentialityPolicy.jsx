            ...
            <div className="white-card">
              <div className="row">
                <div className="col-md-12 p-3">
                    ...
                    <p>Обработка информации осуществляется Оператором, а также иными третьими лицами, которые привлекаются Компанией к обработке, или которым передаются ПДн в указанных целях в соответствии с законодательством Российской Федерации. К числу подобных третьих лиц, в частности, могут относиться:</p>
                    <p>Партнер Оператора, которому данные передаются на основании договора в связи с оказанием Компанией услуг по доставке заказов клиентам Партнера.</p>
